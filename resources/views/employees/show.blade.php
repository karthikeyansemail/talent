        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="detail-list">
                    ...
                    <div class="detail-row">
                        <div class="row-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div>
                        <div class="row-content"><div class="row-label">Jira Tasks</div><div class="row-value">{{ $employee->jiraTasks->count() }} tasks synced</div></div>
                    </div>
                    @endif
                </div>
            </div>
